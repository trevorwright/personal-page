...
const About = () => (
  <ImageBlurb image={trevorImage} alt="Profile Image of Trevor Wright">
    ...
    <p>
      I wan to continually push our industry forward by enabling teams to do amazing work more
      efficiently than ever and find new solutions for the problems we face in the industry. The
      world of web technologies is rapidly evolving and I strive to stay on the cutting edge of it.
    </p>
    <p>
      ...
      ski slopes. I also love cooking as a hobby and as a means of staying nourished.
    </p>
  </ImageBlurb>
)
